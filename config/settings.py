"""
Configuración de Django para El Guri Mates.
"""
...
if CLOUDINARY_URL_ENV:
    # Las imágenes de producto se guardan en Cloudinary (necesario en Vercel,
    # donde el filesystem no es persistente entre despliegues).
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@elgurimates.com')
OWNER_EMAIL = os.environ.get('OWNER_EMAIL', EMAIL_HOST_USER)

if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
else:
    # Sin credenciales configuradas: los emails se imprimen en la consola
    # en vez de enviarse de verdad. Útil para desarrollo local.
